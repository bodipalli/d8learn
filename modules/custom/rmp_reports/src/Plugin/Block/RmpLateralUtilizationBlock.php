...
/**
 * Provides a 'RmpLateralUtilizationBlock' block.
 *
 * @Block(
 *  id = "lateral_utilization_block",
 *  admin_label = @Translation("Rmp Lateral Utilization block"),
 * )
 */
class RmpLateralUtilizationBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    if (!empty($resp)) {
      $build['lateral_utilization_block']['#markup'] = render($resp);
    }
    else {
      $build['lateral_utilization_block']['#markup'] = 'No data';
    }
